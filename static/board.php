...
<rect x="10" y="170" width="16" height="10" fill="pink" stroke="black" onclick="color(this)"/>
<rect x="10" y="190" width="16" height="10" fill="gray" stroke="black" onclick="color(this)"/>
<rect x="10" y="210" width="16" height="10" fill="white" stroke="black" onclick="color(this)"/>
<rect x="10" y="230" width="16" height="10" fill="white" stroke="black" onclick="brush(4)"/>
<circle cx="18" cy="235" r="2" fill="black" stroke="black" onclick="brush(4)"/>
<rect x="10" y="250" width="16" height="10" fill="white" stroke="black" onclick="brush(8)"/>
<circle cx="18" cy="255" r="4" fill="black" stroke="black" onclick="brush(8)"/>
<rect x="10" y="270" width="16" height="10" fill="white" stroke="black" onclick="brush(12)"/>
<circle cx="18" cy="275" r="6" fill="black" stroke="black" onclick="brush(12)"/>
<rect x="10" y="290" width="16" height="10" fill="white" stroke="black" onclick="brush(16)"/>
<circle cx="18" cy="295" r="8" fill="black" stroke="black" onclick="brush(16)"/>
</svg>
