...
<script>
<!--
	if (confirm('Would you like to try a Beta of Android App?')) {
		var a = document.createElement('a');
		a.href = '/static/drawiki.apk';
		a.click();
	}
//-->
</script>
...
?>" data-width="" data-layout="standard" data-action="like" data-size="small" data-share="true"></div><br/></li>
		...
		<div id="tbox2">
			...
			<p>DraWiki is open-source software available under version 3 of the GNU General Public License for anyone to host themselves on <a href="https://github.com/echoline/DraWiki">Github</a>.</p>
			<p><br/></p>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick" />
<input type="hidden" name="hosted_button_id" value="CJXPLN8M9V39U" />
...
<p>
			...
			<p>Site by echoline. Drawings reflect the visitors' opinions, not mine. CSS by <a href="http://freecsstemplates.org/">freecsstemplates.org</a>.
</p>
	</div>
</div>
<script async defer src="//assets.pinterest.com/js/pinit.js"></script>
